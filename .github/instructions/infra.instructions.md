...
- **CORS**: In NestJS `main.ts`, only allow the specific frontend production domain or `localhost:5173`.
- **Environment**: 
...
- **CORS Origins**: Explicitly list the Cloudflare Pages production URL and `http://localhost:5173`. No wildcards permitted.