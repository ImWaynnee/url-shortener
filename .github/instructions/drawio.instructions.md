...
## Styling Guidelines
- **Services (NestJS)**: Light Blue (`fillColor=#dae8fc;strokeColor=#6c8ebf`)
- **Data (Postgres/Redis)**: Green (`fillColor=#d5e8d4;strokeColor=#82b366`)
- **Gateways/Proxies (Nginx)**: Grey (`fillColor=#f5f5f5;strokeColor=#666666`)
- **Edges**: Standard routing style is `edgeStyle=orthogonalEdgeStyle;rounded=0;html=1;`